...
In Stereo-seq builds upon the chip technology already used in MGI DNA nanoball sequencing (DNBSEQ). For background on DNBSEQ, see [here](https://mgi-tech.eu/technology).

The chips are patterned, with fixed spots of 220 nm in diameter and spaced at a distance of 500 or 715 nm.
